 ...
 *
 * Tests the mapping file data/mapping/lido/lido.mc.xml
 * using the fixture mona_lisa.lido.xml (La Joconde).
 *
 * @covers \Mapper\Stdlib\Mapper
 * @covers \Mapper\Stdlib\MapperConfig
 */
class LidoMappingTest extends MapperDbTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->mappingPath = dirname(__DIR__, 3) . '/data/mapping/lido';
    }
    ...
    protected function loadLidoFixture(): void
    {
        ...
        $filePath = $this->fixturesPath . '/mona_lisa.lido.xml';
    ...
    protected function loadExpectedData(): array
    {
        ...
        $filePath = $this->fixturesPath . '/mona_lisa.lido.expected.json';
    ...
    {
        $mappingFile = $this->mappingPath . '/lido.mc.xml';
    ...
    {
        $fixtureFile = $this->fixturesPath . '/mona_lisa.lido.xml';
