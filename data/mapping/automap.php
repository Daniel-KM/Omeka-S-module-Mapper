...
/*
 * Automap configuration: mapping between common field names (spreadsheet column
 * headers) and standard Omeka metadata names from the json-ld representation.
 *
 * Used by Mapper\Stdlib\AutomapFields to automatically suggest field mappings
 * during import configuration.
 *
 * This list can be customized by users.
 */
